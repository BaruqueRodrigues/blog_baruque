...
```{r}  set.seed(43)  #Tamanho Amostral n <- 30  #Variável Independente x <- rnorm(n)  #Variável dependente modelo 1 y1 <- 10 * x + rnorm(n, mean = 50, sd = 100)  #Variável dependente modelo 1 y2 <- 1 * x + rnorm(n,                     mean = 50, sd = 100)  modelo1 <- lm(y1 ~ x) modelo2 <- lm(y2 ~ x)  sjPlot::tab_model(modelo1, modelo2)}
```
...
```{r}  set.seed(43)  #Tamanho Amostral n <- 30  #Variável Independente x <- rnorm(n)  #Variável dependente modelo 1 y1 <- 10 * x + rnorm(n, mean = 50, sd = 500)  #Variável dependente modelo 1 y2 <- 1 * x + rnorm(n,                     mean = 50, sd = 500)   modelo1 <- lm(y1 ~ x) modelo2 <- lm(y2 ~ x)  sjPlot::tab_model(modelo1, modelo2)}
```
